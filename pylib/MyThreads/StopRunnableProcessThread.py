...
##
##	Python module stops a runnable processes in a thread
######################################################################################
##
...
class StopRunnableProcessThread(Thread):
    """StopRunnableProcessThread class extends the Thread class to stop a runnable process."""
    ...
    def __init__(
        ...
        """Class Initializer.
           PARAMETERS:
               ...
               mne	         - Mneumonic.
               processList	 - The list of processes to stop.
    ...
    def run(self):
        """Override the Thread run() method with what we want to do.
           This method performs step 1 of the following steps for a single host in a single thread:
        ...
        self.debug(__name__ + ".run(): self.processList=" + str(self.processList) + "\n")
        ...
        time.sleep(myrand)
        self.status = True
        self.appendMsg(__name__ + ".run(): STOP Completed successfully for " + str(self.threadName) + "\n")
