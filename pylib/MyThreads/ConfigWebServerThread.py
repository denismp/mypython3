...
##
##	Python module to configure a Web Server in a thread.
######################################################################################
##
...
class ConfigWebServerThread( Thread ):
	"""ConfigWebServerThread class extends the Thread class to configure a Web Server in a thread."""
	...
	def run(self):
		"""Override the Thread run() method with what we want to do.
           This method performs step 8 of the following steps for a single host in a single thread:
