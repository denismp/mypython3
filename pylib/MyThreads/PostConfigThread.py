...
class PostConfigThread(Thread):
    """PostConfigThread class extends the Thread class to run postconfig on a host in a thread."""
    ...
    def run(self):
        """Override the Thread run() method with what we want to do.
           This method performs step 5 of the following steps for a single host in a single thread:
