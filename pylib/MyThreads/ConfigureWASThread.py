...
##
##	Python module to configure WAS in a thread.
######################################################################################
##
...
class ConfigureWASThread( Thread ):
	"""ConfigureWASThread class extends the Thread class to configure WAS in a thread."""
	...
	def run(self):
		"""Override the Thread run() method with what we want to do.
           This method performs step 4 of the following steps for a single host in a single thread:
		...
		self.debug( __name__ + ".run(): self.component=" + str( self.component ) + "\n" )
		...
		self.appendMsg( __name__ + ".run(): self.component=" + str( self.component ) + "\n" )
