...
##
##	Python module to configure the MNE in a thread.
######################################################################################
##
...
class ConfigureMNEThread(Thread):
    """ConfigureMNEThread class extends the Thread class to configure the MNE in a thread."""
    ...
    def run(self):
        """Override the Thread run() method with what we want to do.
           This method performs step 3 of the following steps for a single host in a single thread:
