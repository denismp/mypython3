...
class Environment():
	...
	def getEnvironmentVariable(self, name=None, default=''):
		...
		try:
			...
			self.logIt( "pylib.Utils.Environment.getEnvironmentVariable(): Unable to get " + str( e ) + ".  Using " + str( default ) + ".\n" )
			value = default
		#Endtry
	...
	def setEnvironmentVariable(self, name=None, value=None ):
		...
		if value is None:
			self.logIt( "pylib.Utils.Environment.setEnvironmentVariable(): value=" + str( value ) + ".  Environment variable " + str( name ) + " is not set.\n" )
			return
		#Endif
